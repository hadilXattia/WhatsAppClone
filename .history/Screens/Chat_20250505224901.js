...
const Chat = (props) => {
  ...
  const [secondUserStatus, setSecondUserStatus] = useState('');
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.headerTitle}>
            {secondUserName || 'Chat'}{' '}
            <Text style={{ fontSize: 12, color: secondUserStatus === 'online' ? 'green' : 'gray' }}>
              ({secondUserStatus})
            </Text>
          </Text>
          <TouchableOpacity
